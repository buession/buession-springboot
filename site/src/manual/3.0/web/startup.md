...
### [API 参考手册>>](https://javadoc.io/static/com.buession.springboot/buession-springboot-web/3.0.1/com/buession/springboot/web/application/AbstractWebApplication.html)